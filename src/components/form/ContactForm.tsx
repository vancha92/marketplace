...
const ContactForm: React.FC = () => {
  ...
  const validateForm = (): boolean => {
    ...
    (Object.keys(formData) as (keyof FormData)[]).forEach((key) => {
      if (
        !["custNo", "proforma", "comments"].includes(key) &&
        formData[key] === ""
      ) {
        newErrors[key] = true;
        valid = false;
    ...
    <div className="contentContainer flex flex-col gap-4 max-w-[600px]">
      ...
      <div className="flex flex-col bg-base-300 rounded-lg px-1 py-2 gap-4">
        ...
        >
          ...
          <div className="flex flex-col">
            <div className="text-xs lg:text-sm p-1">Proforma</div>
            <input
              type="text"
              name="proforma"
              placeholder="PI12343B"
          ...
          <div className="flex flex-col lg:flex-row gap-2">
            <div className="flex flex-col">
              ...
              <input
                ...
                onChange={handleChange}
                className={`placeholder:text-xs placeholder:text-gray-300 text-base rounded-md px-2 py-1 border-2 ${
                  errors.origin ? "border-red-500" : "border-base-100"
                }`}
              />
            </div>
            <div className="flex flex-col">
              ...
              <input
                ...
                onChange={handleChange}
                className={`placeholder:text-xs placeholder:text-gray-300 text-base rounded-md px-2 py-1 border-2 ${
                  errors.destination ? "border-red-500" : "border-base-100"
                }`}
              />
            </div>
          </div>
          ...
          <div className="flex flex-col lg:flex-row gap-2">
            <div className="flex flex-col">
              ...
              <input
                type="text"
                name="weight"
                placeholder="450.000kg"
                value={formData.weight}
                onChange={handleChange}
                className={`placeholder:text-xs placeholder:text-gray-300 text-base rounded-md px-2 py-1 border-2 w-fit ${
                  errors.weight ? "border-red-500" : "border-base-100"
                }`}
              />
            </div>
            <div className="flex flex-col">
              ...
              <input
                ...
                onChange={handleChange}
                className={`placeholder:text-xs placeholder:text-gray-300 text-base rounded-md px-2 py-1 border-2 w-fit ${
                  errors.date ? "border-red-500" : "border-base-100"
                }`}
              />
            </div>
          </div>
          ...
          <div className="flex flex-col">
            ...
            <textarea
              ...
              onChange={handleChange}
              className={`placeholder:text-xs placeholder:text-gray-300 text-base rounded-md px-2 py-1 border-2 ${
                errors.description ? "border-red-500" : "border-base-100"
              }`}
            />
          </div>
